...
options(warn = 1)
base::assign(".ExTimings", "lpme-Ex.timings", pos = 'CheckExEnv')
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: build_backend
### Title: A function to build the environment for lpme. Builds a conda
...
## Not run: 
##D # Create a conda environment named "lpme"
##D # and install the required Python packages (jax, numpy, etc.)
##D build_backend(conda_env = "lpme", conda = "auto")
##D 
##D # If you want to specify a particular conda path:
##D # build_backend(conda_env = "lpme", conda = "/usr/local/bin/conda")
## End(Not run)
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("lpme", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("lpme_onerun")
### * lpme_onerun
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("lpme_onerun", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
### * <FOOTER>
###
cleanEx()
options(digits = 7L)
